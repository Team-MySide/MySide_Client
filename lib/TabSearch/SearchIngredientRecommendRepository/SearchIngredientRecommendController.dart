...
import 'SearchIngredientRecommendService.dart';
...
class SearchIngredientRecommendController extends GetxController {
  var lst = <String>[].obs;
  ...
  void fetch() async {
    isLoading(true);
    try {
      List<String> products = await SearchIngredientRecommendService().fetch();
      if (products != null) {
        lst.value = products;
      }
    } finally {
