...
class UserInfoPageNumber extends StatelessWidget {
  final int pageNum;
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 12.0,
                    color: pageNum == 3 ? Color(0xFF31B6F7) : Colors.white,
                  ),
                ),
              ],
            ),
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 12.0,
                    color: pageNum == 4 ? Color(0xFF31B6F7) : Colors.white,
                  ),
                ),
              ],
            ),
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  ...
                  style: TextStyle(
                      fontSize: 12.0,
                      color: pageNum == 5 ? Color(0xFF31B6F7) : Colors.white),
                ),
              ],
            ),
          ),
